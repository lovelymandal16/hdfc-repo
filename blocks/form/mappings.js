...
let customComponents = ['dynamic-dropdown', 'dynamic-text', 'custom-text', 'countdown-timer', 'state-button', 'review', 'hdfc-mobile-input', 'kyc-consent', 'dob-input', 'document-upload', 'file-input-v2', 'consent-popup', 'consent-popup-with-goToBottom', 'card-choice', 'single-account-card', 'regex-text-input', 'pan-input', 'custom-text', 'hdfc-card-digit', 'analytics', 'loan-term-slider','loan-range-slider','loan-range-slider-with-ticks'];
